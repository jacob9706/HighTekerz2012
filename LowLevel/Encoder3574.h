...
#ifndef QUAD_ENCODER3574_H_
#define QUAD_ENCODER3574_H_
 ...
 */
class Encoder3574: public SensorBase, public CounterBase, public PIDSource
{
public:
	typedef enum {kDistance, kRate} PIDSourceParameter;

	Encoder3574(UINT32 aChannel, UINT32 bChannel, bool reverseDirection=false, EncodingType encodingType = k4X);
	Encoder3574(UINT8 aModuleNumber, UINT32 aChannel, UINT8 bModuleNumber, UINT32 _bChannel, bool reverseDirection=false, EncodingType encodingType = k4X);
	Encoder3574(DigitalSource *aSource, DigitalSource *bSource, bool reverseDirection=false, EncodingType encodingType = k4X);
	Encoder3574(DigitalSource &aSource, DigitalSource &bSource, bool reverseDirection=false, EncodingType encodingType = k4X);
	virtual ~Encoder3574();
